        ...
        <div class="detail-product-info">
            <div class="info-detail">
                <h1 class="detail-product-h1">
                    <?php echo $resultA['product_name'] ?>
                </h1>
                <h3 class="detail-product-brand">Thương hiệu <a style="color: #E74C3C; text-decoration:none" href="">
                        <?php echo $resultA['categoryItem_name'] ?>
                    </a></h3>
                <span class="etail-product-price-sale" style="color: #E74C3C; font-size: 18px;">
                    <?php echo $resultA['product_price_new'] ?>
                </span>
                <span class="detail-product-price">
                    <?php echo $resultA['product_price'] ?>
                </span>
            </div>

            <a style="text-decoration:none; color:#fff"
                href="confirmProduct.php?product_id=<?php echo $resultA['product_id'] ?>"> <button
                    class="detail-product-btn">Mua hàng</button></a>
        </div>
